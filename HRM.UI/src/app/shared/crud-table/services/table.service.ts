...
import { ITableState, LP_BaseModel, LP_BaseModel_Single, TableResponseModel } from '../models/table.model';
import { BaseModel } from '../models/base.model';
import { SortState } from '../models/sort.model';
import { GroupingState } from '../models/grouping.model';
import { environment } from '../../../environments/environment';
import { AuthModel } from '../models/auth.model';
import { PaginatorComponent } from '../../crud-table/components/paginator/paginator.component';
...
export interface TableResponseModel_LandingPage<T> {
  ...
  panigator: LP_Panigator | null;  // <-- cho phép null nếu có thể không có paginator
}
